...
export const useRoadmapStore = defineStore('roadmap', () => {
  ...
  const createSampleItems = async () => {
    ...
    const sampleItems = [
      ...
      {
        title: 'Добавить пагинацию в селектор сортов',
        description:
          'Реализовать пагинацию в компоненте выбора сорта при добавлении перца для предотвращения зависания устройства',
        priority: 'high' as const,
        status: 'planned' as const,
        category: 'feature' as const,
        targetVersion: '1.1.1',
        notes:
          'При выборе сорта из библиотеки загружаются все сорта сразу, что может вызвать зависание устройства при большом количестве сортов',
        estimatedEffort: 'medium' as const,
      },
    ];
